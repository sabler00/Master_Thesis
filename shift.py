...
if __name__ == "__main__":
    input_file = "soper_2007_H-H.dat"  # Replace with your input file name
    output_file = "soper_2007_H-H_shift.dat"  # Replace with your output file name
    shift_value = -4.0024  # Replace with the value by which you want to shift the y-values
